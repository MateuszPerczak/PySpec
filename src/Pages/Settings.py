...
class Theme(ttk.Frame):
    def __init__(self: object, parent: object, theme: object) -> ttk.Frame:
        ...
        self.header: ttk.Label = ttk.Label(theme_panel, image=self.icon_cache['brush'][theme.get_theme()], text='Theme', style='TLabel', compound='left')
...
class Acceleration(ttk.Frame):
    def __init__(self: object, parent: object, props: object) -> ttk.Frame:
        ...
        self.header: ttk.Label = ttk.Label(self, image=self.icon_cache[self.theme.get_theme()], text='Wheel acceleration', compound='left')
...
class About(ttk.Frame):
    def __init__(self: object, parent: object, theme: object) -> ttk.Frame:
        ...
        self.header: ttk.Label = ttk.Label(self, image=self.icon_cache[theme.get_theme()], text='About PySpec', style='TLabel', compound='left')
        self.header.pack(side='top', fill='x', padx=10, pady=10)
        ttk.Label(self, text='Version: 1.0.0 Build: 110122', style='small.TLabel').pack(side='top', fill='x', padx=10)
        ttk.Label(self, text='Author: Mateusz Perczak', style='small.TLabel').pack(side='top', fill='x', padx=10)
        ttk.Label(self, text='Icons: Icons8', style='small.TLabel').pack(side='top', fill='x', padx=10, pady=(0, 10))
        # bind theme change
        theme.bind(self.__on_theme_changed)
